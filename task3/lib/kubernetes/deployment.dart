...
class _HomePageState extends State<HomePage> {
  ...
  web(name, delete) async {
    var url =
        "http://192.168.43.38/cgi-bin/kubernetes/deployment.py?x=${name}&y=${delete}";
            ...
            children: <Widget>[
              TextFormField(
                ...
                decoration: InputDecoration(
                    labelText: 'Enter_deployment_name',
                    hintText: 'eg. mydeploy',
                    errorStyle:
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    labelText: 'Enter_image_name',
                    hintText: 'eg. httpd,prometheus',
                    errorStyle:
                        TextStyle(color: Colors.yellowAccent, fontSize: 15.0),
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(5.0))),
